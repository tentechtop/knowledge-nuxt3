import { version, getCurrentInstance, inject, ref, computed, unref, defineComponent, h, provide, shallowReactive, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, mergeProps, withCtx, createVNode, createTextVNode, createApp, effectScope, reactive, watchEffect, watch, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, isReadonly, resolveComponent, markRaw, isRef, isShallow, isReactive, toRaw } from 'vue';
import { f as useRuntimeConfig$1, $ as $fetch, i as createError$1, m as defu, n as createHooks, o as hasProtocol, j as joinURL, p as parseURL, q as parseQuery, w as withQuery, r as isScriptProtocol, t as withTrailingSlash, v as withoutTrailingSlash, x as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...all_-b00c2c95.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0b63f2f1.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  "components-header-cpn": () => import('./_nuxt/HeaderCpn-0df307c5.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-1fd37c17.mjs').then((m) => m.default || m),
  home: () => import('./_nuxt/home-b8fb6a39.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-c6135d76.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { COMPANY as C, THEME as T, useNamespace as a, useGetDerivedNamespace as b, createError as c, debugWarn as d, entry$1 as default, useIdInjection as e, useId as f, defaultNamespace as g, throwError as t, useRouter as u };
