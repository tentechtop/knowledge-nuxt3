globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/devalue/index.js';
import { renderToString } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/ofetch/dist/node.mjs';
import destr from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/scule/dist/index.mjs';
import { klona } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://F:/workSpace2024/knowledge-nuxt3/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"F:/workSpace2024/knowledge-nuxt3/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\workSpace2024\\knowledge-nuxt3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\workSpace2024\\knowledge-nuxt3\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\workSpace2024\\knowledge-nuxt3\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\workSpace2024\\knowledge-nuxt3\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"F:\\workSpace2024\\knowledge-nuxt3\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _tAXuwPXkOA = (function(nitro) {
...
const _Ojwzwr6WIl = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_5xQsJw = () => Promise.resolve().then(function () { return pageview$1; });
const _lazy_yxuNiW = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/pageview', handler: _lazy_5xQsJw, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_yxuNiW, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_yxuNiW, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"keywords","name":"keywords","content":""},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"卓越毕设 AEcode-官方网站","htmlAttrs":{}};
...
const getClientManifest = () => import('file://F:/workSpace2024/knowledge-nuxt3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://F:/workSpace2024/knowledge-nuxt3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
